...
type CardAction struct {
	...
	North         []*CardAction            `protobuf:"bytes,5,rep,name=north,proto3" json:"north,omitempty"`
	South         []*CardAction            `protobuf:"bytes,6,rep,name=south,proto3" json:"south,omitempty"`
	East          []*CardAction            `protobuf:"bytes,7,rep,name=east,proto3" json:"east,omitempty"`
	West          []*CardAction            `protobuf:"bytes,8,rep,name=west,proto3" json:"west,omitempty"`
	NorthEast     []*CardAction            `protobuf:"bytes,9,rep,name=north_east,json=northEast,proto3" json:"north_east,omitempty"`
	NorthWest     []*CardAction            `protobuf:"bytes,10,rep,name=north_west,json=northWest,proto3" json:"north_west,omitempty"`
	SouthEast     []*CardAction            `protobuf:"bytes,11,rep,name=south_east,json=southEast,proto3" json:"south_east,omitempty"`
	SouthWest     []*CardAction            `protobuf:"bytes,12,rep,name=south_west,json=southWest,proto3" json:"south_west,omitempty"`
}
...
func (x *CardAction) GetNorth() []*CardAction {
	if x != nil {
		return x.North
	}
	return nil
...
func (x *CardAction) GetSouth() []*CardAction {
	if x != nil {
		return x.South
	}
	return nil
...
func (x *CardAction) GetEast() []*CardAction {
	if x != nil {
		return x.East
	}
	return nil
...
func (x *CardAction) GetWest() []*CardAction {
	if x != nil {
		return x.West
	}
	return nil
...
func (x *CardAction) GetNorthEast() []*CardAction {
	if x != nil {
		return x.NorthEast
	}
	return nil
...
func (x *CardAction) GetNorthWest() []*CardAction {
	if x != nil {
		return x.NorthWest
	}
	return nil
...
func (x *CardAction) GetSouthEast() []*CardAction {
	if x != nil {
		return x.SouthEast
	}
	return nil
...
func (x *CardAction) GetSouthWest() []*CardAction {
	if x != nil {
		return x.SouthWest
	}
	return nil
...
var file_card_action_proto_rawDesc = []byte{
	...
	0x22, 0xbd, 0x04, 0x0a, 0x0a, 0x43, 0x61, 0x72, 0x64, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12,
	...
	,
...
var file_card_action_proto_depIdxs = []int32{
	...
	0,  // 3: Deviant.CardAction.north:type_name -> Deviant.CardAction
	0,  // 4: Deviant.CardAction.south:type_name -> Deviant.CardAction
	0,  // 5: Deviant.CardAction.east:type_name -> Deviant.CardAction
	0,  // 6: Deviant.CardAction.west:type_name -> Deviant.CardAction
	0,  // 7: Deviant.CardAction.north_east:type_name -> Deviant.CardAction
	0,  // 8: Deviant.CardAction.north_west:type_name -> Deviant.CardAction
	0,  // 9: Deviant.CardAction.south_east:type_name -> Deviant.CardAction
	0,  // 10: Deviant.CardAction.south_west:type_name -> Deviant.CardAction
