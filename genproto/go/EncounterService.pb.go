...
var file_EncounterService_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x70, 0x6f, 0x6f, 0x6c, 0x49, 0x44, 0x32, 0xfd, 0x01,
	0x0a, 0x10, 0x45, 0x6e, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x12, 0x4e, 0x0a, 0x0d, 0x46, 0x69, 0x6e, 0x64, 0x45, 0x6e, 0x63, 0x6f, 0x75, 0x6e,
	...
	0x73, 0x65, 0x12, 0x4b, 0x0a, 0x0e, 0x53, 0x74, 0x61, 0x72, 0x74, 0x45, 0x6e, 0x63, 0x6f, 0x75,
	...
	0x74, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x28, 0x01, 0x30, 0x01, 0x12,
	0x4c, 0x0a, 0x0f, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x45, 0x6e, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	...
	0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x28, 0x01, 0x30, 0x01, 0x42, 0x09, 0x5a,
	0x07, 0x64, 0x65, 0x76, 0x69, 0x61, 0x6e, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
type EncounterServiceClient interface {
	FindEncounter(ctx context.Context, in *FindEncounterRequest, opts ...grpc.CallOption) (*FindEncounterResponse, error)
...
func (c *encounterServiceClient) FindEncounter(ctx context.Context, in *FindEncounterRequest, opts ...grpc.CallOption) (*FindEncounterResponse, error) {
	out := new(FindEncounterResponse)
	err := c.cc.Invoke(ctx, "/Deviant.EncounterService/FindEncounter", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EncounterServiceServer interface {
	FindEncounter(context.Context, *FindEncounterRequest) (*FindEncounterResponse, error)
...
func (*UnimplementedEncounterServiceServer) FindEncounter(context.Context, *FindEncounterRequest) (*FindEncounterResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindEncounter not implemented")
}
...
func _EncounterService_FindEncounter_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FindEncounterRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EncounterServiceServer).FindEncounter(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Deviant.EncounterService/FindEncounter",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EncounterServiceServer).FindEncounter(ctx, req.(*FindEncounterRequest))
	}
