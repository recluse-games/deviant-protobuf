...
var file_EncounterService_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x72, 0x32, 0xf9, 0x01, 0x0a, 0x10, 0x45, 0x6e,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x28, 0x01, 0x30, 0x01, 0x12, 0x4a, 0x0a, 0x0d, 0x54, 0x65, 0x73,
	0x74, 0x45, 0x6e, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x72, 0x12, 0x19, 0x2e, 0x44, 0x65, 0x76,
...
var file_EncounterService_proto_depIdxs = []int32{
	...
	0, // 5: Deviant.EncounterService.TestEncounter:input_type -> Deviant.EncounterRequest
	...
	1, // 8: Deviant.EncounterService.TestEncounter:output_type -> Deviant.EncounterResponse
...
type EncounterServiceClient interface {
	...
	TestEncounter(ctx context.Context, opts ...grpc.CallOption) (EncounterService_TestEncounterClient, error)
}
...
func (c *encounterServiceClient) TestEncounter(ctx context.Context, opts ...grpc.CallOption) (EncounterService_TestEncounterClient, error) {
	stream, err := c.cc.NewStream(ctx, &_EncounterService_serviceDesc.Streams[2], "/Deviant.EncounterService/TestEncounter", opts...)
	if err != nil {
		return nil, err
	}
	x := &encounterServiceTestEncounterClient{stream}
	return x, nil
}

type EncounterService_TestEncounterClient interface {
	Send(*EncounterRequest) error
	Recv() (*EncounterResponse, error)
	grpc.ClientStream
}

type encounterServiceTestEncounterClient struct {
	grpc.ClientStream
}

func (x *encounterServiceTestEncounterClient) Send(m *EncounterRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *encounterServiceTestEncounterClient) Recv() (*EncounterResponse, error) {
	m := new(EncounterResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type EncounterServiceServer interface {
	...
	TestEncounter(EncounterService_TestEncounterServer) error
}
...
func (*UnimplementedEncounterServiceServer) TestEncounter(EncounterService_TestEncounterServer) error {
	return status.Errorf(codes.Unimplemented, "method TestEncounter not implemented")
}
...
func _EncounterService_TestEncounter_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(EncounterServiceServer).TestEncounter(&encounterServiceTestEncounterServer{stream})
}

type EncounterService_TestEncounterServer interface {
	Send(*EncounterResponse) error
	Recv() (*EncounterRequest, error)
	grpc.ServerStream
}

type encounterServiceTestEncounterServer struct {
	grpc.ServerStream
}

func (x *encounterServiceTestEncounterServer) Send(m *EncounterResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *encounterServiceTestEncounterServer) Recv() (*EncounterRequest, error) {
	m := new(EncounterRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var _EncounterService_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "TestEncounter",
			Handler:       _EncounterService_TestEncounter_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
